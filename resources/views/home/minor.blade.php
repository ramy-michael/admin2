                      ...
                      <table class="table table-striped table-bordered table-hover dataTables-example" id="gettable2">
                            ...
                            <tbody>
                                  ...
                                  <tr class="gradeX">
                                    ...
                                    <td class="text-center">{{ $Invoice->store_id }}</td>
                                    <td class="text-center">{{ $Invoice->supplier_id }}</td>
                                    <td class="text-center">{{ $Invoice->date }}</td>
                                    <!-- <td class="text-center"><button type="button" class="edit-modal btn btn-primary btn-block btn-lg"data-info="{{$Invoice->supplier_id}},{{$Invoice->supplier_id}}" onclick="show({{ $Invoice->id }});" data-toggle="modal" data-target="#myModal">الاصناف</button>{{ $Invoice->name }}</td> -->
                                    ...
                                    <td class="text-center actions">
                                        ...
                                        <ul class="dropdown-menu" role="menu" style="width: 10%">
                                            <li class="text-center"><a class="btn btn-primary text-center" href="Invoices?id={{$Invoice->id}}" style="font-size: 15px;">تعديل</a></li>
                                            <li class="text-center"><a class="btn btn-primary text-center" href="Purchases?id={{$Invoice->id}}" style="font-size: 15px;">استرجاع</a></li>
                                            <li style="width: 100%;padding: 0 4px;">
                                                <form action="{{ url('Sales/'.$Invoice->id) }}" method="POST"
                                                   style="display: inline-block;width: 100%;">
                                                   {{ csrf_field() }}
                                                   {{ method_field('DELETE') }}
                                                   <button type="submit" style="width: 100%" id="delete-task-{{ $Invoice->id }}"
