                                  ...
                                  <tr class="gradeX">
                                    ...
                                    <td class="text-center actions">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li class="text-center" style="margin: 12px;"><a class="btn btn-primary text-center" href="Invoices" style="font-size: 15px;">تعديل</a></li>
                                            <li style="margin: 12px;">
                                                ...
                                                <li class="text-center" style="margin: 12px;"><a class="btn btn-primary text-center" href="Purchases?id={{$Invoice->num}}" style="font-size: 15px;">استرجاع</a></li>
                                            </li>
                                        </ul>
