                    ...
                    <div class="table-responsive">
                      <table class="table table-striped table-bordered table-hover dataTables-example" id="gettable2">
                            ...
                            <tr>
                                ...
                                <th class="text-center">مصاريف الشحن</th>
                            ...
                            <tbody>
                                  ...
                                  <tr class="gradeX">
                                    ...
                                    <td class="text-center"><?php echo e($Invoice->num); ?></td>
                                    <td class="text-center"><?php echo e($Invoice->store_id); ?></td>
                                    <td class="text-center"><?php echo e($Invoice->supplier_id); ?></td>
                                    <td class="text-center"><?php echo e($Invoice->date); ?></td>
                                    <!-- <td class="text-center"><button type="button" class="edit-modal btn btn-primary btn-block btn-lg"data-info="<?php echo e($Invoice->supplier_id); ?>,<?php echo e($Invoice->supplier_id); ?>" onclick="show(<?php echo e($Invoice->id); ?>);" data-toggle="modal" data-target="#myModal">الاصناف</button><?php echo e($Invoice->name); ?></td> -->
                                    <td class="text-center"><?php echo e($Invoice->total); ?></td>
                                    <td class="text-center"><?php echo e($Invoice->freight_cost); ?></td>
                                    ...
                                    <td class="text-center actions">
                                        ...
                                        <ul class="dropdown-menu" role="menu" style="width: 10%">
                                            <li class="text-center"><a class="btn btn-primary text-center" href="Invoices?id=<?php echo e($Invoice->id); ?>" style="font-size: 15px;">تعديل</a></li>
                                            <li class="text-center"><a class="btn btn-primary text-center" href="Purchases?id=<?php echo e($Invoice->id); ?>" style="font-size: 15px;">استرجاع</a></li>
                                            <li style="width: 100%;padding: 0 4px;">
                                                <form action="<?php echo e(url('Sales/'.$Invoice->id)); ?>" method="POST"
                                                   style="display: inline-block;width: 100%;">
                                                   <?php echo e(csrf_field()); ?>

                                                   <?php echo e(method_field('DELETE')); ?>

                                                   <button type="submit" style="width: 100%" id="delete-task-<?php echo e($Invoice->id); ?>"
