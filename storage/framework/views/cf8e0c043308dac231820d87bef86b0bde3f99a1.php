                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="mb-3 col-lg-4 p-0 col-md-6" style="float: right">
                                    <label class="col-form-label" style="float: right;width: 30%;margin-left: 10px;">رقم الفاتوره:</label>
                                        ...
                                        <input type="text" id="sale_no" value="<?php echo e($Sale_edit[0]->num); ?>" class="form-control" style="width: 65%;float: right" disabled>
                          ...
                          <div class="row">
                              ...
                              <div class="mb-3 col-lg-4 p-0 col-md-6" style="float: right">
                                  <label class="col-form-label" style="float: right;width: 30%;margin-left: 10px;">رقم الفاتوره:</label>
                                      ...
                                      <input type="text" id="sale_no" value="<?php echo e($Sale_no); ?>" class="form-control" style="width: 65%;float: right" disabled>
