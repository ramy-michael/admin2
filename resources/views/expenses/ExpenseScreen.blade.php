                                ...
                                <tbody>
                                    ...
                                    @foreach ($suppliers as $key => $supplier)
                                        <tr class="gradeX">
                                            ...
                                            <td class="text-center">{{$supplier->expense_type2  }}</td>
                                                <?php if($supplier->expense_type==2):?>
                                                <td class="text-center">{{ $supplier->account_name }}</td>
                                                <?php else:?>

                                              
                                                <td class="text-center"> {{ $supplier->expense_name }}</td>
                                                <?php endif?>

                                            

                                            <!-- <td class="text-center">{{ $supplier->credit + $supplier->balance }}</td> -->

                                            <td class="text-center">{{ $supplier->credit }}</td>
                                            ...
                                            <!-- <td class="text-center actions">
                                                ...
                                                <ul class="dropdown-menu" role="menu" style="left: 0px;width: 13%;">
                                                    <li class="text-center" style="margin: 12px;"><a class="btn btn-primary text-center" href="" style="font-size: 15px;">تعديل</a></li>
                                                    <li style="margin: 12px;">
                                                      <form action="{{ url('addexpense/'.$supplier->trans_id) }}" method="POST"
                                                            style="display: inline-block">
                                                          {{ csrf_field() }}
                                                          {{ method_field('DELETE') }}
                                                          <button type="submit" id="delete-task-{{ $supplier->trans_id }}"
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a class="btn btn-xs btn-primary"
                                                   href="{{ url('CashExchange?id='.$supplier->trans_id) }}"><i class="fa fa-edit"></i>
