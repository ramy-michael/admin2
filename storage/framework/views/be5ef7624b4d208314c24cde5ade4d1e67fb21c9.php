                                  ...
                                  <tr class="gradeX">
                                    ...
                                    <td class="text-center actions">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li class="text-center" style="margin: 12px;"><a class="btn btn-primary text-center" href="Invoices?id=<?php echo e($Invoice->id); ?>" style="font-size: 15px;">تعديل</a></li>
                                            ...
                                            <button type="submit" id="delete-task-<?php echo e($Invoice->id); ?>"
                                                    class="btn btn-xs btn-danger">
                                                <i class="fa fa-trash"></i>
                                            </button>
                                        </form>
                                                <li class="text-center" style="margin: 12px;"><a class="btn btn-primary text-center" href="Purchases?id=<?php echo e($Invoice->id); ?>" style="font-size: 15px;">استرجاع</a></li>
                                            </li>
                                        </ul>
