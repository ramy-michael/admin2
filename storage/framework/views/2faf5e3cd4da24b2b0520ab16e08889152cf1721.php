        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="height: 330px;">
                    ...
                    <form class="form-horizontal row" role="form" method="POST" action="<?php echo e(url('Suppliers')); ?>">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="form-group<?php echo e($errors->has('balance') ? ' has-error' : ''); ?> row" style="float: right;width: 100%">
