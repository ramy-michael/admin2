                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-lg-4">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input type="text" id="sale_no" value="<?php echo e($Sale_edit[0]->num); ?>" class="form-control" disabled>
                            ...
                            <div class="mb-3 col-lg-4">
                                ...
                                <div class="col-sm-7">
                                    <select class="js-example-basic-single" name="manufacturingNumber" style="width: 100%;"id="product_id">
                                      ...
                                      <option  value="<?php echo e($product->id); ?>"><?php echo e($product->product_name); ?>_<?php echo e($product->num); ?></option>
                          ...
                          <div class="row">
                              ...
                              <!-- <div class="row"> -->
                                  <div class="mb-3 col-lg-4">
                                      <label class="col-form-label">سعر البيع (الطن)</label>
                                      <div class="col-sm-9">
                                          <input type="text" id="product_price" class="form-control">
                                      </div>
                                  </div>
                                  ...
                                  <div class="mb-3 col-lg-4">
                                      <label class="col-form-label"> الكميه بالمخزن :</label>
                                      <div class="col-sm-9">
                                          <input type="text" id="product_repeat" class="form-control">
                                      </div>
                                  </div>
                                  <div class="mb-3 col-lg-4">
                                      <label class="col-form-label">نوع الشكاره :</label>
...
// $("#total").val(<?php echo e($Sale_edit[0]->total); ?>)
$("#client_balance").val(<?php echo e($Sale_edit[0]->balance-$Sale_edit[0]->total); ?>)
x=0
...
x++
$('#gettable tbody').append('<tr id='+'<?php echo e($sale_edit->product_id); ?>><td style="display:none;">'+'<?php echo e($sale_edit->p_type_id); ?>'+'</td><td>'+x+'</td><td>'+"<?php echo e($sale_edit->product_name); ?>_<?php echo e($sale_edit->num); ?>"+'</td><td>'+"<?php echo e($sale_edit->product_qty); ?>"+'</td><td>'+<?php echo e($sale_edit->sale_price); ?>+'</td><td>'+"<?php echo e($sale_edit->name); ?>"+'</td><td>'+'<?php echo e($sale_edit->p_weight); ?>'+'</td><td>'+'<?php echo e($sale_edit->p_count); ?>'+'</td><td><button onclick="newtest(this)"  class="btn btn-danger "><i class="fas fa-trash-alt"></i></button></td></tr>');
 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
$('#product_id').on('change', function() {
  ...
  <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  if(<?php echo e($product->id); ?>==$('#product_id').val()){

$('#product_cost').val(<?php echo e($product->total_price); ?>)
$('#product_repeat').val(<?php echo e($product->repeat_num); ?>)
...
// console.log(sale_items)
    ...
    <?php if(isset($_GET['id'])): ?>
      ...
      $.ajax({
        url: "<?php echo e(URL::to('updatesale')); ?>",
        type: "post",
        dataType: 'json',
    ...
    if(response.status=="success"){
      window.location.href = "/Sales";
        ...
        <?php else: ?>
        $.ajax({
          url: "<?php echo e(URL::to('createSale')); ?>",
          type: "post",
          dataType: 'json',
          data: {"_token":$('#_token').val(),
          "sale_items":sale_items,
