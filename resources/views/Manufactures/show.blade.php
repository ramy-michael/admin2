                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                      <table class="table table-striped table-bordered table-hover dataTables-example" >
                            ...
                            <!-- <a href="{{ route('Manufactures.index')}}" class="btn btn-success"style="margin-left:1207px;">New Item</a> -->
                            <tbody>
                            @foreach ($Products as $key => $Product)
                                <tr class="gradeX">
                                    ...
                                    <td class="text-center">{{ $Product->product_name }}_{{ $Product->num }}</td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a class="btn btn-xs btn-primary"
                                           href="{{ route('Manufactures.index',['id' => $Product->id]) }}"><i class="fa fa-edit"></i>
                                        </a>
                                        <form action="{{ url('Manufactures/'.$Product->id) }}" method="POST"
