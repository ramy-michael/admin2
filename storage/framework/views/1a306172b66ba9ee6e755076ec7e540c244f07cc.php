                            ...
                            <div class="row" style="width: 100%;">
                                <div class="col-lg-3">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="text" id="num"class="form-control" value="<?php echo e($manufacture_no); ?>"style="width: 100%;">
                                    </div>
                                </div>
...
// alert(item_id);
 ...
 if(item_id==''||item_id==null){
  ...
  $('#gettable tbody').append('<tr id=r'+count+'><td>'+count+'</td><td>'+item_name+'</td><td>'+ratio_per_ton+'</td><td>'+price+'</td><td><a href="#" onclick="delete_item('+count+','+price+');" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a></td></tr>');
...
if($('#repeat_num').val()==''){
  ...
  $('#message').show().html(' يرجى ادخال تكلفه الطن ');
