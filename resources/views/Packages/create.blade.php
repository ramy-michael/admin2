                ...
                <div class="panel-body" style="height: 300px;">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('Packages') }}">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <br>
                            <div class="form-group{{ $errors->has('weight') ? ' has-error' : '' }} row" style="float: right;width: 100%">
                                {{-- <div class="col-lg-11"> --}}
                            ...
                            <br>
                            <!-- <div class="form-group{{ $errors->has('weight') ? ' has-error' : '' }} row" style="margin-top: 20px;">
                                <div class="col-lg-11">
                        ...
                        <div class="form-group" style="margin-top: 30px;">
                            <div class="col-md-8 col-md-offset-4">
                                ...
                                <a class="btn btn-link" href="{{ url('Packages') }}"> الغاء</a>
                            </div>
                        </div>
                    </form>
                </div>
