            ...
            <div class="col-lg-12">
                ...
                <div class="alert alert-danger text-right" id="message" style="display:none;"></div>
                    <div class="alert  alert-info text-right" id="success" style="display:none;"></div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-sm-12 col-md-12" style="width: 100%;">
                                <div class="col-lg-4 mt-3 p-0" style="float: right">
                                    <label class="col-form-label" style="float: right;width: 30%;margin-left: 10px;">رقم التصنيع:</label>
                                    {{-- <div class="col-sm-9"> --}}
                                        @if(isset($_GET['id']))
                                        <input type="text" id="num"class="form-control" value="{{$updated_manufacture[0]->num}}"style="width: 65%;"disabled>

                                        @else
                                        <input type="text" id="num"class="form-control" value="{{$manufacture_no}}" style="width: 65%;float: right" disabled>

                                        @endif
                                    {{-- </div> --}}
                                </div>
                                <div class="col-lg-4 mt-3 p-0" style="float: right">
                                    <label class="col-form-label" style="float: right;width: 30%;margin-left: 10px;"> التاريخ:</label>
                                    {{-- <div class="col-sm-9"> --}}
                                        <input type="text" id="date" class="form-control" style="width: 65%;float: right" disabled>
                                    {{-- </div> --}}
                                </div>
                                <div class="col-lg-4 mt-3 p-0" style="float: right">
                                    <label class="col-form-label" style="float: right;width: 30%;margin-left: 10px;">رقم التكرار:</label>
                                    {{-- <div class="col-sm-9"> --}}
                                        <input type="number" id="repeat_num"class="form-control" style="width: 65%;float: right">
                                    {{-- </div> --}}
                                </div>
                                <div class="col-lg-4 mt-3 p-0" style="float: right">
                                    <label class="col-form-label" style="float: right;width: 30%;margin-left: 10px;">اسم المنتج :</label>
                                    {{-- <div class="col-sm-9"> --}}
                                        <input type="text"id="product_name" class="form-control" style="width: 65%;float: right">
                                    {{-- </div> --}}
                                </div>
                            
                                
                                <div class="col-lg-4 mt-3 p-0" style="float: right">
                                    <label class="col-form-label" style="float: right;width: 30%;margin-left: 10px;">الصنف :</label>
                                    {{-- <div class="col-sm-9"> --}}
                                        <select class="js-example-basic-single"  style="width: 65%;float: right" id="item_id">
                                ...
                                <div class="col-lg-4 mt-3 p-0" style="float: right">
                                    <label class="col-form-label" style="float: right;width: 30%;margin-left: 10px;">النسبه/الطن :</label>
                                    {{-- <div class="col-sm-9"> --}}
                                        <input type="text" id="ratio_per_ton" class="form-control" style="width: 65%;float: right">
                                    {{-- </div> --}}
                                </div>
                                <div class="col-lg-4 mt-3 p-0" style="float: right">
                                    <label class="col-form-label" style="float: right;width: 30%;margin-left: 10px;">السعر للطن :</label>
                                    {{-- <div class="col-sm-9"> --}}
                                        <input type="text" id="price" class="form-control" style="width: 65%;float: right" disabled>
                                    {{-- </div> --}}
                                </div>
                                <div class="col-lg-4">
                                    {{-- <div class="col-sm-9"> --}}
                                      <!-- <input type="hidden" name="total_ton" id="total_ton" > -->
                                        ...
                                        <input type="button" onclick="add()" class="btn btn-primary mt-3 mb-5" value="اضف" style="width: 80px;">
                        ...
                        <div class="row mb-3 mt-4">
                            ...
                            <div class="col-lg-6 col-sm-12 col-md-6 mt-3" style="float: right">
                                <label class="col-form-label" style="float: right;width: 30%;margin-left: 10px;"> تكلفه الطن الواحد :</label>
                                {{-- <div class="col-sm-9"> --}}
                                    <input type="text" id="total2" class="form-control" style="width: 65%;float: right" disabled>
                                {{-- </div> --}}
                            </div>
                            <div class="col-lg-6 col-sm-12 col-md-6 mt-3" style="float: right">
                                <label class="col-form-label" style="float: right;width: 30%;margin-left: 10px;"> الاجمالى :</label>
                                {{-- <div class="col-sm-9"> --}}
                                    <input type="text" id="total" class="form-control" style="width: 65%;float: right" disabled>
                                {{-- </div> --}}
                            </div>
                            {{-- </div> --}}
                            {{-- <div class="row mb-3"> --}}
                            ...
                            <div class="col-lg-6 col-sm-12 col-md-6 mt-3" style="float: right">
                                <label class="col-form-label" style="float: right;width: 30%;margin-left: 10px;"> اجمالي التصنيع :</label>
                                {{-- <div class="col-sm-9"> --}}
                                    <input type="text" id="total_ton" class="form-control" style="width: 65%;float: right" disabled>
                                {{-- </div> --}}
                            </div>
                        </div>
...
@if(isset($_GET['id']))
$("#product_name").val("{{$updated_manufacture[0]->product_name}}")
$("#total").val({{$updated_manufacture[0]->total_price}})
$("#total2").val({{$updated_manufacture[0]->total_per_ton}})
$("#repeat_num").val({{$updated_manufacture[0]->repeat_num}})
$("#total_ton").val(700)
x=0
$("#date").datepicker().datepicker("setDate", new Date());

 @foreach($manufacture_edit as $manufacture)
x++
$('#gettable tbody').append('<tr id='+'{{$manufacture->item_id}}><td>'+x+'</td><td>'+"{{$manufacture->name}}"+'</td><td>'+"{{$manufacture->ratio}}"+'</td><td>'+{{$manufacture->price}}+'</td><td><button onclick="newtest(this)"  class="btn btn-danger "><i class="fas fa-trash-alt"></i></button></td></tr>');
 @endforeach
@else
$("#date").datepicker().datepicker("setDate", new Date());
...
$('#item_id').on('change', function() {
  ...
  if($('#item_id').val()=="{{$item->id}}"){
    console.log("{{$item->item_price}}","{{$item->name2}}");
