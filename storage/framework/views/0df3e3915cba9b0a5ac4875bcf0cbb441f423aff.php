                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-lg-4">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input type="text" id="sale_no" value="<?php echo e($Sale_no); ?>" class="form-control" disabled>
                                ...
                                <div class="col-sm-7">
                                    <select class="js-example-basic-single" name="manufacturingNumber" style="width: 100%;"id="product_id">
                                      <option disabled value selected value=''></option>
                                       ...
                                       <?php $__currentLoopData = $Sales_edit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale_edit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                      <option  value="<?php echo e($sale_edit->product_id); ?>" name="<?php echo e($sale_edit->sale_detail_id); ?>"><?php echo e($sale_edit->product_name); ?>_<?php echo e($sale_edit->num); ?></option>
...
// alert('hdhd')
$("#client_id").val(<?php echo e($Sale_edit[0]->customer_id); ?>)
document.getElementById("client_id").disabled = true;
$("#client_balance").val(<?php echo e($Sale_edit[0]->customer_id); ?>)
// $("#total").val(<?php echo e($Sale_edit[0]->total); ?>)

$("#sale_id").val(<?php echo e($Sale_edit[0]->id); ?>)
// $("#total").val(<?php echo e($Sale_edit[0]->total); ?>)
$("#client_balance").val(<?php echo e($Sale_edit[0]->balance); ?>)
x=0
...
$('#package_type').on('change', function() {
  ...
  if(<?php echo e($item->id); ?>==$('#package_type').val()){
console.log(<?php echo e($item->weight); ?>);
$('#package_weight').val(<?php echo e($item->weight); ?>)
$('#package_num').val(<?php echo e($item->quantity); ?>)
...
console.log($( "#product_id option:selected" ).attr("name"))
  ...
  //if(<?php echo e($sale_edit->product_id); ?>==$('#product_id').val()){
  if(<?php echo e($sale_edit->sale_detail_id); ?>==$( "#product_id option:selected" ).attr("name")){

$('#sale_price').val(<?php echo e($sale_edit->sale_price); ?>)
$('#saled_qty').val(<?php echo e($sale_edit->product_qty); ?>)
console.log('<?php echo e($sale_edit->p_type_id); ?>')
$("#package_type").val("<?php echo e($sale_edit->name); ?>")
$("#package_type").attr("name",'<?php echo e($sale_edit->p_type_id); ?>')
$('#package_weight').val(<?php echo e($sale_edit->p_weight); ?>)
$('#package_count').val(<?php echo e($sale_edit->p_count); ?>)
}
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php $__currentLoopData = $previous_returns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $previous_return): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

if(<?php echo e($previous_return->product_id); ?>==$('#product_id').val()){
  $("#previous_return_qty").val("<?php echo e($previous_return->reverse_qty); ?>")
...
console.log(return_items)
    // else{
      ...
      $.ajax({
        url: "<?php echo e(URL::to('createReturn')); ?>",
        type: "post",
        dataType: 'json',
