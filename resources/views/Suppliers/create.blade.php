        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="height: 330px;">
                    ...
                    <form class="form-horizontal row" role="form" method="POST" action="{{ url('Suppliers') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="form-group{{ $errors->has('balance') ? ' has-error' : '' }} row" style="float: right;width: 100%">
                                {{-- <div class="col-lg-11"> --}}
                        ...
                        <div class="form-group row" style="margin: 30px 20px 20px 0px">
                            <div class="col-md-8 col-md-offset-4">
                                <button type="submit" class="btn btn-primary"> حفظ</button>
                                <a class="btn btn-link" href="{{ url('Suppliers') }}"> الغاء</a>
                            </div>
                        </div>
                    </form>
                </div>
