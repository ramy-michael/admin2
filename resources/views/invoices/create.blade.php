                  ...
                  <!--   @if (count($errors) > 0)
                    ...
                    <form class="form-horizontal" role="form" method="POST" >
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group required{{ $errors->has('num') ? ' has-error' : '' }}">
                                <label for="num" class="col-md-4 control-label">رقم الفاتوره</label>
                                <div class="col-md-6">
...
@endsection
<script>
var x = document.getElementsById("supplier_id2").value.trim();
document.getElementById("supplier_id").value=x;
