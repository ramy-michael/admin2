                    ...
                    <div class="row">
                      <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="supplier" value="{{$supplier_name[0]->name}}" class="form-control" disabled>
                            </div>
                        </div>
...
$('#previous_quantity').val({{$updated_invoice[0]->previous_quantity}});

  @foreach ($invoices_details as $invoices_detail)
  if($('#item_id').val()=="{{$invoices_detail->item_id}}"){
    // console.log("{{$invoices_detail->id}}");
    $('#now_quantity').val("{{$invoices_detail->quantity}}");


  }
@endforeach
@foreach ($invoices_refunds as $invoices_refund)
if($('#item_id').val()=="{{$invoices_refund->item_id}}"){
  console.log("{{$invoices_refund->previous_quantity}}");
  if("{{$invoices_refund->previous_quantity}}"==''){
    $('#previous_quantity').val(0);

  }else{
    $('#previous_quantity').val("{{$invoices_refund->refund_quantity}}");
