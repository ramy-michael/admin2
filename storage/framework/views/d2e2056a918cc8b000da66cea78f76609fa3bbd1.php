                    ...
                    <div class="ibox-content " style="">
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example" >
                                ...
                                <tbody>
                                    <!-- <tr class="gradeX"> -->
                                      <?php $__currentLoopData = $clinets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $clinet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <tr class="gradeX">
                                              ...
                                              <td class="text-center"><?php echo e($clinet->name); ?></td>
                                              <td class="text-center"><?php echo e($clinet->depit + $clinet->balance); ?></td>

                                              <td class="text-center"><?php echo e($clinet->depit); ?></td>
                                              <td class="text-center"><?php echo e($clinet->balance); ?></td>
                                              ...
                                              <td class="text-center">
                                                  ...
                                                  href="<?php echo e(url('ReceiveCash?id='.$clinet->trans_id)); ?>"><i class="fa fa-edit"></i>

                                                  </a>
                                                  <form action="<?php echo e(url('addexpense/'.$clinet->trans_id)); ?>" method="POST"
                                                        style="display: inline-block">
                                                      <?php echo e(csrf_field()); ?>

                                                      <?php echo e(method_field('DELETE')); ?>

                                                      <button type="submit" id="delete-task-<?php echo e($clinet->id); ?>"
