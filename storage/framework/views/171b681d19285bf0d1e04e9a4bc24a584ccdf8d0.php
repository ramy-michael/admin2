    ...
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu" style="background: #233645;padding: 0;">
            ...
            <li class="<?php echo e(isActiveRoute('payments')); ?> dropdown">
                <a href="#" id="dropdownMenuButton1" style="font-size: 20px" data-bs-toggle="dropdown" aria-expanded="false"><span class="nav-label">تحصيلات و سدادات</span><i class="fas fa-sort-down"></i></a>
