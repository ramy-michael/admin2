                ...
                <div class="panel panel-default" style="height: 100%">
                    ...
                    <div class="row" style="height: 100%">
                      ...
                      <!--  <form class="form-horizontal" role="form" method="POST"
                            ...
                            <div class="{{ $errors->has('name') ? ' has-error' : '' }} col-lg-12 col-md-12 col-sm-12" style="float: right;margin-top: 25px;width:100%;">
                                ...
                                {{-- <div class="col-md-6"> --}}
                                    <input id="name" type="text" class="form-control" name="name"
                                           value="{{$supplier->name}}" style="width: 70%;float: right"
                                           required autofocus>
                            ...
                            <div class="{{ $errors->has('code') ? ' has-error' : '' }} col-lg-12 col-md-12 col-sm-12" style="float: right;margin-top: 25px;width:100%;">
                                <label for="code" class="control-label" style="float: right;width: 25%;margin-left: 10px;">الكود</label>

                                {{-- <div class="col-md-6"> --}}
                                    <input id="code" type="text" class="form-control" name="code"
                                           value="{{$supplier->code}}" style="width: 70%;float: right"
                                           required autofocus>
                            ...
                            <div class="{{ $errors->has('password') ? ' has-error' : '' }} col-lg-12 col-md-12 col-sm-12" style="float: right;margin-top: 25px;width:100%;">
                                <label for="phone"   class="control-label" style="float: right;width: 25%;margin-left: 10px;">التليفون</label>

                                {{-- <div class="col-md-6"> --}}
                                    <input id="phone" type="text" value="{{$supplier->phone}}" class="form-control" name="phone" style="width: 70%;float: right" autofocus>
                                    @if ($errors->has('phone'))
                                        <span class="help-block">
                            ...
                            <div class="{{ $errors->has('address1') ? ' has-error' : '' }} col-lg-12 col-md-12 col-sm-12" style="float: right;margin-top: 25px;width:100%;">
                                <label for="address1" class="control-label" style="float: right;width: 25%;margin-left: 10px;">
                                    العنوان</label>

                                {{-- <div class="col-md-6"> --}}
                                    <input id="address1" type="text" value="{{$supplier->address1}}"class="form-control" style="width: 70%;float: right"
