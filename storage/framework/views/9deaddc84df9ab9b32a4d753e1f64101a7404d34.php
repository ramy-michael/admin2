                    ...
                    <div class="panel-body">
                      ...
                      <!--  <form class="form-horizontal" role="form" method="POST"
                            ...
                            <div class="form-group<?php echo e($errors->has('code') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-6">
                                    <input id="code" type="text" class="form-control" name="code"
                                           value="<?php echo e($supplier->code); ?>"
                                           required autofocus>
                            ...
                            <div class="form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-6">
                                    <input id="phone" type="text" value="<?php echo e($supplier->phone); ?>" class="form-control" name="phone" autofocus>
                            ...
                            <div class="form-group<?php echo e($errors->has('address1') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-6">
                                    <input id="address1" type="text" value="<?php echo e($supplier->address1); ?>"class="form-control"
