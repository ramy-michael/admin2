                            ...
                            <div class="col-lg-12 col-sm-12 col-md-12" style="width: 100%;">
                                <div class="col-lg-4 mt-3 p-0" style="float: right">
                                    <label class="col-form-label" style="float: right;width: 30%;margin-left: 10px;">رقم التصنيع:</label>
                                        ...
                                        <input type="text" id="num"class="form-control" value="<?php echo e($updated_manufacture[0]->num); ?>"style="width: 65%;"disabled>

                                        <?php else: ?>
                                        <input type="text" id="num"class="form-control" value="<?php echo e($manufacture_no); ?>" style="width: 65%;float: right" disabled>
